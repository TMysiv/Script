...
// ];
//
// for (let simp of simpsons) {
//     let div = document.createElement('div');
//     div.classList.add('member');
//     div.innerText =`${simp.age} ${simp.name} ${simp.info} ${simp.surname}`
//
...
// for (let key of simpsons) {
//     let div = document.createElement('div');
//     div.classList.add('member');
//
//     let nameDiv = document.createElement('div');
//     nameDiv.innerText = `${key.name}`;
//
//     let surnameDiv = document.createElement('div');
//     surnameDiv.innerText = `${key.surname}`;
//
//     let ageDiv = document.createElement('div');
//     ageDiv.innerText = `${key.age}`;
//
//     let infoDiv = document.createElement('div');
//     infoDiv.innerText = `${key.info}`
//
//
//     div.append(nameDiv,surnameDiv,ageDiv,infoDiv)
//     document.body.appendChild(div)
// }
