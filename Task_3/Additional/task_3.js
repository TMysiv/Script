...
//     }
// ];
// document.write(`<div style="display: flex;flex-wrap: wrap;justify-content: space-between;row-gap: 10px">`)
// for (let i=0; i<array.length;i++){
//     document.write(`<div style="display: flex; flex-direction: column;width: 19%;border: 1px solid yellow;">`);
